...
<div class="xs">
	<h3>Form Periode BOR, LOS, TOI, BTO</h3>
	<div class="tab-content">
		<div class="tab-pane active" id="horizontal-form">
			<?php echo validation_errors(); ?> 
			<?php $attributes = array('class' => 'form-horizontal'); ?>
			<?php echo form_open('prm/index_btbl', $attributes); ?>
			<form class="form-horizontal" method="POST">
				<div class="form-group">
					<label for="jenis" class="col-sm-2 control-label">Laporan</label>
					<div class="col-sm-8">
						<select name="jenis" id="selector1" class="form-control1 ng-invalid ng-invalid-required" required>
