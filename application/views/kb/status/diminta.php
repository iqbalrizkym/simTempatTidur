...
<div class="xs">
	<h3>Form Pemakaian Tempat Tidur</h3>
	<div class="tab-content">
		<div class="tab-pane active" id="horizontal-form">
			<?php echo validation_errors(); ?> 
			<?php foreach ($gunattawal as $tt) {?>
				<form class="form-horizontal" action="<?php echo base_url('kb/update_diminta_dipakai/'.$this->uri->segment(3).'/'.$tt['kd_gn'].'/'.$tt['kd_rm']); ?>" enctype="multipart/form-data" method="post" >
					...
					<div class="panel-footer">
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								...
								<button type="submit" name="submit" class="btn btn-danger" formaction="<?php echo base_url('kb/update_diminta_kosong/'.$this->uri->segment(3).'/'.$tt['kd_gn'].'/'.$tt['kd_rm']); ?>">Ubah ke Status Kosong</button>
							</div>
						</div>
					</div> 
				</form>
