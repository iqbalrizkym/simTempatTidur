	...
	<div class="tab-content">
		<div class="tab-pane active" id="horizontal-form">
			...
			<?php foreach ($gunattawal as $tt) {?>
				<form class="form-horizontal" action="<?php echo base_url('kb/update_dipesan_disiapkanpesan/'.$this->uri->segment(3).'/'.$tt['kd_gn'].'/'.$tt['kd_rm']); ?>" enctype="multipart/form-data" method="post" >
					...
					<div class="panel-footer">
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								<button type="submit" name="submit" class="btn btn-success warning_2">Ubah ke Status Disiapkan</button>
							</div>
						</div>
					</div> 
				</form>
