...
<div class="xs">
	<h3>Form StatusTempat Tidur</h3>
	<div class="tab-content">
		<div class="tab-pane active" id="horizontal-form">
			<?php echo validation_errors(); ?> 
			<?php foreach ($ttkosong as $tt) {?>
			<form class="form-horizontal" action="<?php echo base_url('kb/update_rusak_kosong/'.$this->uri->segment(3)); ?>" enctype="multipart/form-data" method="post" >
				...
				<div class="form-group">
					...
					<label for="status_tt" class="col-sm-2 control-label">Kelas</label>
					<div class="col-sm-8">
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button type="submit" name="submit" class="btn btn-success warning_2">Ubah ke Status Kosong</button>
						</div>
					</div>
				</div> 
			<?php } ?>
