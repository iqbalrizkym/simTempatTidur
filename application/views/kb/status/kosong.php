...
<div class="xs">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="horizontal-form">
			...
			<form class="form-horizontal" action="<?php echo base_url('kb/update_kosong_rusak/'.$this->uri->segment(3)); ?>" enctype="multipart/form-data" method="post" >
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-sm-8 col-sm-offset-2">
							<button type="submit" name="submit" class="btn btn-success warning_2">Ubah ke Status Rusak</button>
						</div>
					</div>
				</div> 
			<?php } ?>
