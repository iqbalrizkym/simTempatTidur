...
<div class="xs">
	...
	<div class="tab-content">
		<div class="tab-pane active" id="horizontal-form">
			...
			<?php echo form_open('kb/update_profil/'.$this->session->userdata('kd_akt'), $attributes); ?>
			...
			<form class="form-horizontal">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
						<input disabled type="text" class="form-control1" id="focusedinput" name="level" value="<?php echo $this->session->userdata('level'); ?>" required>
					</div>									
				</div>
