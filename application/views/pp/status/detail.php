                ...
                foreach ($status as $item){
                    if ($item['status_tt'] == 'Diminta') { ?>
                        <tr>
                            ...
                            <td style="text-align: center;"><span class='fa fa-pencil' aria-hidden='true' style="color: red"></span></td>
                        </tr>
            ...
            foreach ($tt_kosong as $item1){ 
                if ($item1['status_tt'] == 'Kosong'){
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;"><a href='<?php echo site_url('pp/add_alokasi/'.$item1['kd_bgs'].'/'.$item1['kd_tt']); ?>'><span class='fa fa-pencil' aria-hidden='true'></span ></a></td>
                    </tr>
