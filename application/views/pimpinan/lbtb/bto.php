<div class="but_list">
	<ol class="breadcrumb">
		...
		<li><a href="<?php echo site_url('pimpinan/periode_btbl'); ?>">Periode</a></li>
		<li class="active">LOS, BOR, TOI, BTO</li>
	</ol>
</div>
<div class="xs">
	<div class="bebas">
			...
			<table id="example" class="table table-bordered" cellspacing="0" width="100%">
				<thead>
					<tr>
						...
						<th data-sortable="true" width="24%">Nilai BTO</th>
